...
const fmtSize = (n) => n >= 100 ? n.toFixed(2) : n >= 1 ? n.toFixed(4) : n.toFixed(6);
...
const I = {
  ...
  trend: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="3 17 9 11 13 15 21 7"/><polyline points="14 7 21 7 21 14"/></svg>,
...
Object.assign(window, { fmtUSD, fmtBig, fmtPct, fmtSize, I, Sparkline });
